...
if __name__== "__main__":
    ...
    parser.add_argument('-c','--category', type=str, nargs='+', default=None, help='Indicating the categories are going to be used for training. You can list name of the classes you want to use in training. If you wish to use all classes then you can use *. For instnce <-c cat dog>. Default: cat')
